...
//
#define ROUTINE_DRAW01			    0
#define ROUTINE_COLORSQUARE			1
#define ROUTINE_DDAINIT     		2
#define ROUTINE_DDASTEP0			3
#define ROUTINE_DDASTEP1			4
#define ROUTINE_DDASTEP2			5
#define ROUTINE_DRAW02			    6
#define ROUTINE_COLORRIGHTTEXEL		7
#define ROUTINE_COLORLEFTTEXEL		8
#define PROFILER_ROUTINE_COUNT   	9	


FUNCTIONNAME(ROUTINE_DRAW01,"drawImage01")
FUNCTIONNAME(ROUTINE_COLORSQUARE,"colorSquare")
FUNCTIONNAME(ROUTINE_DDAINIT,"ddaInit")
FUNCTIONNAME(ROUTINE_DDASTEP0,"ddaStep0")
FUNCTIONNAME(ROUTINE_DDASTEP1,"ddaStep1")
FUNCTIONNAME(ROUTINE_DDASTEP2,"ddaStep2")
FUNCTIONNAME(ROUTINE_DRAW02,"drawImage02")
FUNCTIONNAME(ROUTINE_COLORRIGHTTEXEL,"colorRightTexel")
FUNCTIONNAME(ROUTINE_COLORLEFTTEXEL,"colorLeftTexel")
